...
tox -e integration-object-storage   # integration tests (sidecar mode & object-storage relation)
tox -e integration-ambient          # integration tests (ambient mode & object-storage relation)
