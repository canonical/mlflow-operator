...
from charmlibs.interfaces.service_mesh import MeshType, ServiceMeshConsumer
                ...
                responses.append(
                    (
                        ...
                        ResourceProviderModel(
                            ...
                            # (using some shared secret behind the scenes) and for the
                            # functionality of the employed library:
