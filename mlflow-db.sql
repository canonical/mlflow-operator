...
CREATE TABLE `datasets` (
  ...
  `dataset_profile` text DEFAULT NULL,
...
INSERT INTO `experiments` VALUES (0,'Default','s3://mlflow/0','active',NULL,NULL);
...
CONSTRAINT-1` CHECK (`is_nan` in (0,1)),
  CONSTRAINT `CONSTRAINT_2` CHECK (`is_nan` in (0,1))
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `metrics` (
  ...
  CONSTRAINT `CONSTRAINT_1` CHECK (`is_nan` in (0,1))
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `runs` VALUES ('63c8716a595f4a188ce60f535b6fea74','','UNKNOWN','','','pocik','FINISHED',1690363973958,1690363975828,'','active','s3://mlflow/0/63c8716a595f4a188ce60f535b6fea74/artifacts',0,NULL);
...
-- Dump completed on 2023-07-26 11:43:27
